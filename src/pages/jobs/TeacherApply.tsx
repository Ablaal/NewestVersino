      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">{t('Teacher Application Form', 'Foomka Codsiga Macallinka')}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="position" value={t('Teacher', 'Macallin')} disabled className="bg-gray-100" />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select required>
                    ...
                    <SelectContent>
                      <SelectItem value="bachelor">{t('Bachelor\'s Degree', 'Shahaadada Heerka Koowaad')}</SelectItem>
                ...
                <div className="space-y-2">
                  <Label htmlFor="experience">{t('Years of Experience', 'Sanooyinka Khibradda')} *</Label>
                  <Select required>
                    <SelectTrigger>
                      <SelectValue placeholder={t('Select years', 'Dooro sanooyinka')} />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="0-2">0-2 {t('years', 'sano')}</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="coverLetter"
                  rows={4}
                  placeholder={t('Tell us why you want to join our team...', 'Noo sheeg sababta aad rabto inaad ku biirto kooxdeena...')}
                />
              </div>
